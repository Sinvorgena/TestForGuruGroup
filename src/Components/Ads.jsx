...
let Ads = (props) => {
    ...
    useEffect(() => {
        setLimitationСardsField(props.cardsData.slice(0, 16).map(el =>
                ...
                <div className={s.itemImgBox}>
                    ...
                    <span className={`${s.swapImg} ${s.firstImg}`}>
                        <input type="radio" onClick={() => {
                            props.setCurrentImgSucsess(`${el.id + 0}`)
                            el.currentImg = 0
                    ...
                    <span className={`${s.swapImg} ${s.second}`}>
                        <input type="radio" onClick={() => {
                            props.setCurrentImgSucsess(`${el.id + 1}`)
                            el.currentImg = 1
                    ...
                    <span className={`${s.swapImg} ${s.third}`}>
                        <input type="radio" onClick={() => {
                            props.setCurrentImgSucsess(`${el.id + 2}`)
                            el.currentImg = 2
                    ...
                    <span className={`${s.swapImg} ${s.four}`}>
                        <input type="radio" onClick={() => {
                            props.setCurrentImgSucsess(`${el.id + 3}`)
                            el.currentImg = 3
        ...
        setCardsField(props.cardsData.map(el =>
            <div className={!el.seen ? `${s.item}` : `${s.item} ${s.itemSeen}`}>
                <div className={s.itemImgBox}>
                    <p className={s.textItemHasBeenSeen}>Просмотрено</p>
                    <span className={`${s.swapImg} ${s.firstImg}`}>
    ...
    }, [props.imgUrlData.length, props.currentImg])

    let [limitationСardsField, setLimitationСardsField] = useState(props.cardsData.slice(0, 16).map(el =>
        <div className={!el.seen ? `${s.item}` : `${s.item} ${s.itemSeen}`}>
            <div className={s.itemImgBox}>
                <p className={s.textItemHasBeenSeen}>Просмотрено</p>
                <span className={`${s.swapImg} ${s.firstImg}`}>
    ...
    let [СardsField, setCardsField] = useState(props.cardsData.map(el =>
        <div className={!el.seen ? `${s.item}` : `${s.item} ${s.itemSeen}`}>
            <div className={s.itemImgBox}>
                <p className={s.textItemHasBeenSeen}>Просмотрено</p>
                <span className={`${s.swapImg} ${s.firstImg}`}>
    ...
    return (
        <div className={s.AdsPage}>
            <div className={s.wrapper}>
                {isShowAll ? СardsField : limitationСardsField}
            </div>
